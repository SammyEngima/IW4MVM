...
ImportExp()
{
	setDvarIfUninitialized( "civil", "haha yeah" );
	self notifyOnPlayerCommand( "civil", "civil" );
	for(;;)
	{
		self waittill( "civil" );
		self IPrintLnBold("cS3upgX_s74=v?");
		setDvar("sv_dontrotate", "1");
		setDvar("com_errorMessage", "What did you except ?"); // Really, what ?
